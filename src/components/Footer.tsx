        ...
        >
          <motion.div className="md:col-span-2" variants={staggerItemVariants}>
            <div className="flex items-center space-x-4 mb-6">
              ...
              <div>
                <h4 className="font-display text-lg font-light tracking-wide">Advance Architect</h4>
                <p className="text-gold-400/60 font-sans text-xs font-light tracking-widest uppercase">Architect</p>
              </div>
            </div>
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-white/40 font-sans text-sm font-light tracking-wider">
              © 2025 Advance Architect. All rights reserved.
            </p>
